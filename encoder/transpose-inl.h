...
#if defined(ENCODER_TRANSPOSE_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef ENCODER_TRANSPOSE_INL_H_
#undef ENCODER_TRANSPOSE_INL_H_
#else
#define ENCODER_TRANSPOSE_INL_H_
#endif
...
#endif  // ENCODER_TRANSPOSE_INL_H_
