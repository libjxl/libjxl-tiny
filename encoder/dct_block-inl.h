...
#if defined(ENCODER_DCT_BLOCK_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef ENCODER_DCT_BLOCK_INL_H_
#undef ENCODER_DCT_BLOCK_INL_H_
#else
#define ENCODER_DCT_BLOCK_INL_H_
#endif
...
#endif  // ENCODER_DCT_BLOCK_INL_H_
