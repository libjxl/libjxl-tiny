...
#if defined(ENCODER_DEC_TRANSFORMS_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef ENCODER_DEC_TRANSFORMS_INL_H_
#undef ENCODER_DEC_TRANSFORMS_INL_H_
#else
#define ENCODER_DEC_TRANSFORMS_INL_H_
#endif
...
#endif  // ENCODER_DEC_TRANSFORMS_INL_H_
