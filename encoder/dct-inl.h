...
#if defined(ENCODER_DCT_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef ENCODER_DCT_INL_H_
#undef ENCODER_DCT_INL_H_
#else
#define ENCODER_DCT_INL_H_
#endif
...
#include "encoder/dct_block-inl.h"
#include "encoder/dct_scales.h"
#include "encoder/transpose-inl.h"
