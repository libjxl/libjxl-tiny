...
#if defined(ENCODER_RATIONAL_POLYNOMIAL_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef ENCODER_RATIONAL_POLYNOMIAL_INL_H_
#undef ENCODER_RATIONAL_POLYNOMIAL_INL_H_
#else
#define ENCODER_RATIONAL_POLYNOMIAL_INL_H_
#endif
...
HWY_AFTER_NAMESPACE();
#endif  // ENCODER_RATIONAL_POLYNOMIAL_INL_H_
