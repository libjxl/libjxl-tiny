...
#if defined(ENCODER_QUANTIZER_INL_H_) == defined(HWY_TARGET_TOGGLE)
#ifdef ENCODER_QUANTIZER_INL_H_
#undef ENCODER_QUANTIZER_INL_H_
#else
#define ENCODER_QUANTIZER_INL_H_
#endif
...
#endif  // ENCODER_QUANTIZER_INL_H_
